...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Médicaments en stock minimum</h1>
<p class="mb-4">Vous trouverez dans ce tableau tous les médicaments en stock minimum .</a>.</p>
...
<div class="card shadow mb-4">
  ...
  <div class="card-header py-3">
      <div class="row">
          ...
          <div class="col-sm-4"> 
          <h6 class="m-0 font-weight-bold text-info col-10">Stock minimum</h6> 
          </div>
